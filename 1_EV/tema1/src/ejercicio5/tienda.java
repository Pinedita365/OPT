...
public class tienda {
    public static void main(String[] args) {
        ...
        productos.add(new cereales(1.0, 2.5, tipo.avena));
        productos.add(new cereales(1.1, 3.0, tipo.maiz));
        productos.add(new cereales(1.2, 3.5, tipo.trigo));
        productos.add(new cereales(1.3, 4.0, tipo.chocolate));
        ...
        dt.add(new detergente(500, 2.0, 5.0,"Plastico",2)); // volumen, marca, precio
